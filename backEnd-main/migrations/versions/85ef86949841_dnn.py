...
def upgrade():
    ...
    op.create_table('student_bus_destination',
    sa.Column('student_id', sa.Integer(), nullable=False),
    sa.Column('bus_destination_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['bus_destination_id'], ['bus_destination.id'], ),
    sa.ForeignKeyConstraint(['student_id'], ['student.id'], ),
    sa.PrimaryKeyConstraint('student_id', 'bus_destination_id')
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('student_bus_destination')
